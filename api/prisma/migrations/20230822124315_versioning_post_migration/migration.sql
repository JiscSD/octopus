/*
  ...
  - Made the column `linkToVersion` on table `Links` required. This step will fail if there are existing NULL values in that column.
  ...
  - Made the column `licence` on table `PublicationVersion` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE "Links" ALTER COLUMN "linkToVersion" SET NOT NULL;
