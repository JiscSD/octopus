    ...
    return (
        <>
            ...
            <Layouts.Standard fixedHeader={true}>
                ...
                <Components.Section
                    id="content"
                    className="bg-teal-300 dark:bg-grey-700"
                    wave={true}
                    waveFill="fill-teal-300 dark:fill-grey-700"
                >
                ...
                {/** Get started */}
                <Components.Section
                    className="bg-teal-700 dark:bg-grey-800"
                    wave={true}
                    waveFill="fill-teal-700 dark:fill-grey-800"
                >
                ...
                {/** Help improve */}
                <Components.Section
                    className="bg-teal-500 dark:bg-grey-700"
                    wave={true}
                    waveFill="fill-teal-500 dark:fill-grey-700"
                >
