    ...
    return (
        <>
            <Head>
                ...
                <meta name="og:title" content={Config.urls.browsePublications.title} key="og:title" />
                <meta name="og:description" content={Config.urls.browsePublications.description} key="og:description" />
