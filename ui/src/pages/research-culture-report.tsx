            ...
            <Layouts.Standard>
                <section className="container mx-auto px-8 pb-10 pt-10 text-grey-800 transition-colors duration-500 dark:text-white-100 lg:gap-4 lg:pt-20">
                    <Components.PageTitle
                        className="mb-8"
                        text="New report questions impact of publishing on research culture"
                    />
                    ...
                    <div className="text-sm text-grey-800 transition-colors duration-500 dark:text-grey-100">
                        ...
                        <div className="flex justify-center gap-6">
                            <Components.Link
                                className="flex w-full items-center justify-center rounded-lg border-transparent bg-grey-700 p-4 text-center font-montserrat text-sm font-medium tracking-wide text-white-50 decoration-teal-500 underline-offset-2 outline-0 transition-colors duration-500 hover:bg-grey-600 focus:overflow-hidden focus:ring-2 focus:ring-yellow-400 dark:bg-teal-600 dark:hover:bg-teal-600 sm:w-fit sm:px-4"
                                title="Report"
                            ...
                            <Components.Link
                                className="flex w-full items-center justify-center rounded-lg border-transparent bg-grey-700 p-4 text-center font-montserrat text-sm font-medium tracking-wide text-white-50 decoration-teal-500 underline-offset-2 outline-0 transition-colors duration-500 hover:bg-grey-600 focus:overflow-hidden focus:ring-2 focus:ring-yellow-400 dark:bg-teal-600 dark:hover:bg-teal-600 sm:w-fit sm:px-4"
                                title="Report"
                                href="https://doi.org/10.57874/axc8-vs07"
                                openNew
                            >
                                Read the Octopus publications
                            </Components.Link>
                        </div>
                    </div>
                    <br />
                    ...
                    <div className="text-sm text-grey-800 transition-colors duration-500 dark:text-grey-100">
                        <p>
                            ...
                            improved&quot;, was conducted to create a benchmark to measure the effectiveness of the
                            Research England funded, and Jisc supported online publishing platform Octopus.ac.
                        </p>
                        <br />
                        <p>
                            ...
                            &quot;impactful&quot; results as feeling like &quot;I&apos;m a novel writer instead of a
                            researcher&quot;.
                        </p>
                        <br />
                        <p>
                            The report found that a third of researchers had not published research because it did not
                            have a clean enough &quot;story&quot; to make it attractive to publishers, and one in five
                            had not published research they had undertaken because they felt it would not help their
                            career.
                        </p>
                        <br />
                        <p>
                            Nearly half (46%) of respondents said they would not publish ideas or methods for fear of
                            being &quot;scooped&quot;, because only &quot;findings&quot; mattered. About a third said
                            they saw no benefit to their careers in sharing work quickly and openly.
                        </p>
                        <br />
                        <p>
                            ...
                            assessment, and 41% of respondents thought that open research practices had &quot;no
                        ...
                        <br />
                        <p>
                            Researchers reported feeling under pressure to achieve an &quot;interesting&quot; or
                            statistically significant result that is more likely to appeal to a journal. The authors
                            found this could encourage questionable research practices such as data manipulation. The
                            report also showed that younger or less-experienced researchers don&apos;t receive
                            proportional credit for their work.
                        </p>
                        <br />
                        ...
                        <ul className="list-inside list-disc indent-6 leading-relaxed">
                            ...
                            <li>
                                ...
                                than a narrative &quot;paper&quot; to minimise publication bias and the pressures that
                                lead to QRPs.
                            </li>
                        </ul>
                        <br />
                        <p>
                            ...
                            published. In some situations, these pressures lead to questionable research
                            practices.&quot;
                        </p>
                        <br />
                        <p>
                            &quot;In general, open research practices are viewed as not beneficial, or even detrimental,
                            to job security and career advancement. This is especially true given competing demands and
                            the need for academics to prioritise their time on outputs that count in assessments that
                            they are subject to.&quot;
                        </p>
                        <br />
                        <p>
                            Jisc&apos;s director of product for research management, Liz Bal, said: &quot;We&apos;re
                            committed to supporting our members explore future research dissemination models, with
                            Octopus being one such model. As a technology partner to Octopus, we welcome this report in
                            guiding its development and hope that it stimulates further discussion among institutions on
                            the relationships between research culture and research dissemination.&quot;
                        </p>
                        <br />
                        <p>
                            Octopus platform founder Dr Alexandra Freeman said: &quot;It&apos;s heartbreaking to read
                            how researchers currently feel. The current system incentivises the wrong things.&quot;
                        </p>
                        <br />
                        <p>
                            &quot;This means that those wanting to do the best quality research have to actively swim
                            against the tide. Octopus is designed to realign research incentives to reward people for
                            the intrinsic quality of what they do, removing the concept of &quot;scooping&quot;,
                            encouraging specialisation, and removing the feeling of having to &quot;be good at
                            everything&quot;.&quot;
                        </p>
                    </div>
                </section>
