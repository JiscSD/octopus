        ...
        <Layouts.Standard fixedHeader={false}>
            ...
            <section className="container mx-auto my-16 px-8 2xl:my-36">
                <ul className="mx-auto 2xl:w-8/12">
                    <li className="mb-8 flex items-start gap-4 font-montserrat text-lg leading-relaxed text-grey-700 transition-colors duration-500 dark:text-white lg:pl-6">
                    ...
                    <li className="mb-20 flex items-start gap-4 font-montserrat text-lg leading-relaxed text-grey-700 transition-colors duration-500 dark:text-white lg:pl-6">
            ...
            <section className="container mx-auto px-8 lg:mb-6">
                <div className="mx-auto mb-2 flex flex-col items-center gap-1 font-montserrat text-base font-semibold uppercase tracking-wide text-grey-900 transition-colors duration-500 dark:text-white lg:text-xl">
                    <OutlineIcons.UserCircleIcon className="mb-2 h-6 w-6 rounded-full bg-teal-500 p-1 text-white shadow transition-colors duration-500" />
                    Peer Review
                </div>
            ...
            <section className="container mx-auto mb-10 px-8 py-32 pb-10 text-grey-900 dark:text-white lg:mb-2">
                <Components.PageSubTitle text="Principles of Octopus" />

                <ul className="mb-16 space-y-4">
                    <li className="flex items-center">
                        <OutlineIcons.LightBulbIcon className="mr-4 hidden h-6 w-6 text-grey-800 transition-colors duration-500 dark:text-white lg:block" />
            ...
            <section className="container mx-auto px-8 pt-10 lg:pt-20">
                ...
                <div className="mx-auto mb-24 grid gap-8 lg:my-24 lg:grid-cols-4">
                    <div className="mx-auto text-center lg:col-start-2 lg:col-end-3">
                        <OutlineIcons.DesktopComputerIcon className="mx-auto mb-4 h-8 w-8 text-teal-500 dark:text-white" />
                    ...
                    <div className="mx-auto text-center lg:col-start-3 lg:col-end-3">
                        <OutlineIcons.PencilIcon className="mx-auto mb-4 h-8 w-8 text-teal-500 dark:text-white" />
                        <h3 className="mb-4 block font-montserrat text-lg font-bold text-grey-800 transition-colors duration-500 dark:text-white">
            ...
            <section className="container mx-auto px-8 pb-20 lg:py-20">
                <div className="space-y-16 2xl:px-28">
                    <div>
                        <OutlineIcons.StarIcon className="col-span-1 mt-1 block h-8 w-8 fill-yellow-200 text-grey-900 transition-colors duration-500 dark:fill-yellow-500 dark:text-white lg:mr-4" />
                        <h3 className="my-4 font-montserrat text-lg font-semibold text-grey-800 transition-colors duration-500 dark:text-white">
                    ...
                    <div>
                        <OutlineIcons.FlagIcon className="col-span-1 mt-1 block h-8 w-8 fill-peach-300 text-grey-900 transition-colors duration-500 dark:text-white lg:mr-4" />
                        <h3 className="my-4 font-montserrat text-lg font-semibold text-grey-800 transition-colors duration-500 dark:text-white">
