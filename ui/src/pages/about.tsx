                ...
                >
                    <section>
                        <div className="container mx-2 px-8 pt-8 pb-8 lg:mx-auto lg:pt-24">
                            ...
                            <h2 className="mx-auto mb-16 block text-center font-montserrat text-xl font-medium leading-relaxed text-grey-700 transition-colors duration-500 dark:text-grey-100 lg:mb-28 lg:text-2xl">
                        ...
                        <div className="container mx-auto px-8">
                            <ul className="mx-auto lg:w-8/12">
                                <li className="mb-8 flex min-h-[3rem] items-start gap-4 font-montserrat text-xl leading-relaxed text-grey-700 transition-colors duration-500 dark:text-white lg:pl-6 lg:text-lg">
                                    ...
                                    <span>
                                        Easy for institutions and funders to see exactly what you&apos;ve done and how
                                        it has been regarded by others.
                                    </span>
                                </li>
                                <li className="mb-8 flex min-h-[3rem] items-start gap-4 font-montserrat text-xl leading-relaxed text-grey-700 transition-colors duration-500 dark:text-white lg:pl-6 lg:text-lg">
                                ...
                                <li className="mb-8 flex min-h-[3rem] items-start gap-4 font-montserrat text-xl leading-relaxed text-grey-700 transition-colors duration-500 dark:text-white lg:pl-6 lg:text-lg">
                                    ...
                                    <span>
                                        Free for researchers to publish their work, free for anyone to read and embeds
