        ...
        items: [
            {
                ...
                content:
                    '<strong>Problem:</strong> There is a widely-recognised problem with &apos;publication bias&apos;, which means that &apos;positive&apos; findings, or things that are thought to be more exciting to readers are more easily published and few outlets publish replications or &apos;negative results&apos;; and some types of work are much harder to publish than others. <br /> <br /> <strong>What Octopus is doing to help:</strong> The emphasis on Octopus is on high-quality outputs at every stage, not creating a particular narrative around the findings. Octopus removes editorial gatekeepers which means that there are no artificial barriers to publishing work - and what is incentivised are indicators of good quality/best practice in the research process, rather than any feature of the &apos;findings&apos; or &apos;impact&apos;. This allows the publication of all types of work, whatever the topic or result.'
            },
            {
                header: 'Institutional bias',
                content:
                    '<strong>Problem:</strong> These is a recognised publication bias in favour of academic work done within higher education institutions, and much research work done outside of these is not shared in the same way since traditional articles are very time-consuming to write and there is little incentive to spend resources unless an author &apos;needs&apos; a publication for their career. Research not shared is often repeated or not learned from by others. <br /> <br /><strong>What Octopus is doing to help:</strong> On Octopus sharing work is quicker, easier, and carries no financial burden, reducing the &apos;publishing overhead&apos;. Those not in academia (i.e. practitioners and commercial researchers) and those with less access to funding are better able to share their work. This leads to less of a divide between academic and &apos;grey&apos; literature.'
            },
            {
                header: 'The influence of &apos;impact&apos; on research topic',
                content:
                    '<strong>Problem:</strong> There is currently a bias in the choice of research topics by researchers based on those prioritised by &apos;high impact publications&apos; meaning that many topics get less attention.<br /> <br /> <strong>What Octopus is doing to help:</strong> The removal of &apos;impact&apos; as a basis for judging quality removes this bias: good quality work is good quality work regardless of field or topic (or the research stage featured in the publication).'
            },
            {
                header: 'Publication language',
                content:
                    '<strong>Problem:</strong> The majority of traditional publishers publish English-language content only, meaning there are high barriers to publication or reading research for non-native English speakers. <br /><br /> <strong>What Octopus is doing to help:</strong> Authors can publish in any language and users can filter search results by language. When the reversioning feature is released, authors will also have the option to publish multiple versions in different languages. <br /> <br />We are also hoping to integrate an automated translation tool which would deliver high-quality translations of academic works. This would allow the platform to be truly language-agnostic, so that everyone can seamlessly read and write in their own native language. This is a high priority feature for us and we hope to have it in place soon. This is a high priority feature for us, and we will be investigating options to take forward.'
            },
            {
                header: 'Real-world implementation',
                content:
                    '<strong>Problem:</strong> There is a lack of emphasis on real-world implementation in the current publication process, leading to too much &apos;theoretical&apos; work and not enough &apos;useful&apos; work being shared. <br /> <br /> <strong>What Octopus is doing to help:</strong> In Octopus, real world implementation ideas are a publication type of their own, focussing researchers&apos; efforts on these in their own right, and not – as is often the case at the moment - an add-on few sentences at the end of a traditional research article. It also allows much more research on and understanding of how generalisable many findings and techniques developed through research really are.'
            }
        ]
    },
    {
        ...
        items: [
            {
                ...
                content:
                    '<strong>Problem:</strong> Traditional research articles often have large author groups which do not accurately reflect who does what, which can be especially problematic for junior or specialist researchers (e.g. analysts, technicians).<br /><br /> <strong>What Octopus is doing to help:</strong> smaller publications encourage smaller author groups that more accurately reflect the work done at each stage, leading to more meritocratic recognition, especially for specialists (see below)'
            },
            {
                header: 'Recognition for specialists',
                content:
                    '<strong>Problem:</strong> There is a lack of recognition for specialists, and unspecialised researchers are incentivised to complete some aspects of a research chain which they are not trained to do (e.g. statistical analysis, code-writing, qualitative analysis) in order to be able to complete a full research article for publication. <br /><br /> <strong>What Octopus is doing to help:</strong> In Octopus, the publication of smaller units of research work means that specialists can now publish their own work, or publish in smaller author groups, with different groups potentially working at each stage to form a collaborative whole. This can allow more specific recognition for individuals&apos; work and specialities. Over time, an author&apos;s Octopus profile page will build a picture of the kind of work they publish (e.g. they publish mainly hypotheses – they&apos;re an &apos;ideas person&apos;; or they publish mainly protocols – they&apos;re a &Apos;design person&apos;; or they publish mainly analyses etc). Because each stage of work is judged on its own merits, researchers should feel less compelled to produce all stages of the research process.'
            },
            {
                header: 'Proxy metrics and &apos;impact&apos;',
                content:
                    '<strong>Problem:</strong> The only metrics to judge quality, of both research and researchers, at the moment are poor proxies such as H-index and Journal Impact Factors, leading to perverse incentive structures. <br /> <br /> <strong>What Octopus is doing to help:</strong> We want to move away from poor proxy metrics of value and impact. Currently the red flag process allows users to quickly indicate a serious issue with a publication, which the author can then address. Longer-term, we are working to ensuring the value and quality of Octopus publications by exploring different approaches to assessment with the research community, such as additional community moderation features, which will allow users to rate or recommend content. We can also explore integrations with automatic plagiarism detection software including inbuilt image manipulation detection.'
            },
            {
                header: 'Copyright',
                content:
                    '<strong>Problem:</strong> Authors often have to sign over copyright when publishing their work. <br /> <br /><strong>What Octopus is doing to help:</strong> Octopus is not a &apos;publisher&apos; and authors stay in control of their own copyright, choosing a Creative Commons copyright license. Our only requirements are that the work is published open access, and that it allows derivative works (so that we can include it in upcoming features like translation).'
            }
        ]
    },
    {
        title: 'Finding relavent research',
        href: 'FindingRelaventResearch',
        items: [
            {
                header: 'Finding research',
                content:
                    '<strong>Problem:</strong> There is a huge volume of traditional publications, in different journals, making it very difficult to find relevant quality research. <br /> <br /> <strong>What Octopus is doing to help:</strong> Each Octopus publication must be linked to at least one other, creating a network of branching chains. These chains each start with a &apos;Problem&apos;, providing a structure to the content on the site and making it easy to find content related to a certain research problem. <br /> <br /> We will shortly release a feature which allows researchers to subscribe to publications and so receive notifications of newly published work linked, for instance, to a particular research problem or dataset.'
            },
            {
                header: 'Cross- and multi-disciplinary work',
                content:
                    '<strong>Problem:</strong> There are currently silos and divides between research fields as researchers tend to work in particular groups and publish in certain journals. <br /> <br /> <strong>What Octopus is doing to help:</strong> There are no disciplinary categories in Octopus. Instead, all research being published in one place and linked to other publications. Readers can also add relevant cross-links, regardless of discipline. For example, a reader could cross-link a publication created under a Problem in one field with a publication liked under a completely different Problem, in what would traditionally be recognised as another field. This will hopefully build bridges between traditional silos and recognise cross and multi-disciplinary work'
            }
        ]
    }
];
