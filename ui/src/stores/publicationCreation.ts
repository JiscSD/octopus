...
let store: any = (set: (params: any) => void) => ({
    ...
    hasNoAffiliations: false,
    updateHasNoAffiliations: (hasNoAffiliations: boolean) => set(() => ({ hasNoAffiliations })),
    hasAffiliations: false,
    updateHasAffiliations: (hasAffiliations: boolean) => set(() => ({ hasAffiliations })),
    affiliationsStatement: '',
