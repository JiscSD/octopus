        ...
        <HeadlessUI.Transition.Root show={props.open} as={React.Fragment}>
            ...
            >
                <div className="flex min-h-full items-center justify-center text-center">
                    ...
                    >
                        <div className="xl:max-w-2 relative mx-8 my-20 inline-block w-11/12 transform overflow-hidden rounded-lg bg-grey-100 px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:px-8 sm:py-6 sm:align-middle lg:max-w-xl">
                            <div>
                                <div className="mt-3 sm:mt-5">
                                    ...
                                    <h4 className=" eading-6 mt-6 font-montserrat text-base font-semibold text-grey-900">
                                        {props.subTitle}
                                    </h4>
