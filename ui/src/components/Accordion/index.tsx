...
const Accordion: React.FC<Props> = (props): JSX.Element => (
    <HeadlessUI.Disclosure>
        {({ open }) => (
            <>
                <HeadlessUI.Disclosure.Button className="flex max-w-full justify-between rounded-lg bg-teal-100 px-4 py-2 text-left font-montserrat text-xl text-teal-900 outline-0 hover:bg-teal-200 focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 dark:bg-grey-700 dark:text-white">
                    {props.heading}
