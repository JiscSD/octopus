...
const Footer: React.FC = (): JSX.Element => (
    <>
        <Assets.WaveOne
            waveFillTop="fill-teal-500 dark:fill-grey-600"
            waveFillMiddle="fill-teal-600 dark:fill-grey-700"
            waveFillBottom="fill-teal-700 dark:fill-grey-800"
        />
            ...
            <div className="container mx-auto grid grid-cols-1 gap-8 px-8 md:grid-cols-4">
                ...
                <div className="col-span-1 flex space-x-4 pt-4 md:col-span-3 lg:col-span-3">
                    <Components.Link
                        ...
                        className="h-fit"
                    >
                        <Assets.Github height={25} width={25} className="fill-white" />
                    </Components.Link>
                    <Components.Link
                        ...
                        className="h-fit"
                    >
                        <Assets.Twitter width={25} height={25} className="fill-white" />
                    </Components.Link>
                </div>
                {/** Links */}
