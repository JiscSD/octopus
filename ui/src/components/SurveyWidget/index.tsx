    ...
    if (feedback)
        return (
            <Framer.motion.div
                ...
                className="fixed left-0 bottom-0 z-30 w-full rounded-tr-lg bg-teal-300 py-4 pl-6 pr-8 text-grey-800 transition-all duration-500 dark:bg-teal-700 dark:text-grey-100 md:w-72"
            >
