            ...
            <div className="space-y-2">
                {props.sectionList.map((section) => (
                    <button
                        ...
                        className="mb-2 mr-2 block rounded border-transparent text-sm font-medium text-teal-600 outline-0 transition-colors duration-500 hover:underline focus:overflow-hidden focus:ring-2 focus:ring-yellow-400 dark:text-teal-400"
                    >
                        {section.title}
                    </button>
                ))}
