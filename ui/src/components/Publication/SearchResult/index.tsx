    ...
    return (
        ...
        >
            <Components.Link
                ...
                className={`mx-4 my-4 block p-2 outline-0 focus:rounded focus:border-transparent focus:ring-2 focus:ring-yellow-500 ${props.className}`}
            >
                ...
                <span className="mt-1 block text-lg tracking-wide text-grey-800 dark:text-white">{props.title}</span>
