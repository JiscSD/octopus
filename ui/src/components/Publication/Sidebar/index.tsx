    ...
    <div className="sticky top-16">
        ...
        {props.jumpToList.map((jumpTo: JumpTo) => (
            <button
                ...
                className={`mb-1 block w-fit rounded border-transparent py-1 text-teal-600 outline-0 transition-colors duration-500 hover:underline focus:ring-2 focus:ring-yellow-400 dark:text-grey-100 ${
