            ...
            >
                <div className="flex min-h-full items-center justify-center text-center">
                    ...
                    >
                        <div
                            className={
                                (loading ? 'sm:pb-6' : 'px-4 pt-5 sm:px-8 sm:py-6') +
                                ' xl:max-w-2 relative mx-8 my-20 inline-block w-11/12 transform overflow-hidden rounded-lg bg-white-50 pb-4 text-left align-bottom shadow-xl transition-all sm:align-middle lg:max-w-xl'
                            }
                        >
                            <Components.ModalBarLoader loading={loading} />
                            <div className={loading ? 'px-4 sm:px-8' : ''}>
                                <div>
                                    {!!props.icon && (
